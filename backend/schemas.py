...
class MappingSchema(BaseModel):
    ...
    match_name: str = Field(description="Best match concept name")
    match_id: int = Field(description="Match concept ID")
    match_vocab: str = Field(description="Match vocabulary")
    score: float = Field(description="Similarity score (0-1)")
    standard_name: str = Field(description="Standard OMOP concept name")
    standard_id: int = Field(description="Standard concept ID")
    standard_vocab: str = Field(description="Standard vocabulary")
